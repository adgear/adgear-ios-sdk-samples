...
- (void)registerUrl:(nonnull NSURL *)url method:(nullable NSString *)method andPayload:(nullable NSString *)payload mocked:(BOOL)mocked withCompletion:(nullable void(^)(BOOL success))block;
